...
export interface GxsdtDuplicatasBaixa {
    DuplicataId: number;
    DuplicataNumero: string;
    DuplicataEmissao: string;
    DuplicataVencimento: string;
    DuplicataValor: number;
    TipoBaixaDuplicata: string;
    DuplicataJuros: number;
    DuplicataDescontos: number;
    DuplicataValorPago: number;
    isCobrarJuros: boolean;
    descSituacao: string;
    codSituacao: number;
